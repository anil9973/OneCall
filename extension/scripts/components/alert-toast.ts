...
class AlertBox extends HTMLElement {
	...
	show = (noticeTxt: string, type: "success" | "error" | "warning" = "success"): void => {
		this.box.className = type;
		(this.box.children[1] as HTMLElement).textContent = noticeTxt;
		this.showPopover();
	...
	connectedCallback(): void {
		...
		this.box = this.firstElementChild as HTMLDivElement;
