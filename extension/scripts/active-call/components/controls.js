...
class CallControls extends HTMLElement {
  state;
  constructor(state) {
    super();
  }
  ...
  render() {
    return html`<button @click=${this.toggleMute.bind(this)}>
			...
			${() => this.state.aiState === "acting" ? html`<button class="control-btn stop-btn" @click=${this.handleStop.bind(this)} title="Stop AI action">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
								<path fill="currentColor" d="M6,6H18V18H6V6Z" />
							</svg>
							<span class="btn-label">Stop</span>
					  </button> ` : html`<div class="volume-control">
