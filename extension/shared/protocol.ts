/** * Messages sent FROM Call engine TO Content Script * that represent AGENT TOOL EXECUTION. */
export const EngineToWidgetToolAction = {
	// Navigation
...
export type EngineToWidgetToolAction = (typeof EngineToWidgetToolAction)[keyof typeof EngineToWidgetToolAction];
...
export const EngineToWidgetAction = {
	EXECUTE_TOOL: "EXECUTE_TOOL",
	SHOW_WIDGET: "SHOW_WIDGET",
	HIDE_WIDGET: "HIDE_WIDGET",
	TOGGLE_WIDGET: "TOGGLE_WIDGET",
};
export type EngineToWidgetAction = (typeof EngineToWidgetAction)[keyof typeof EngineToWidgetAction];

/**  Messages sent FROM content script TO service worker */
export const WidgetToEngineAction = {
...
export type WidgetToEngineAction = (typeof WidgetToEngineAction)[keyof typeof WidgetToEngineAction];
