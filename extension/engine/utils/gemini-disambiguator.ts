import type { ElementData } from "../../scripts/active-call/tools/dom-extractor.js";

export class GeminiDisambiguator {
	...
	async selectElement(userIntent: string, elements: ElementData[]): Promise<number[]> {
